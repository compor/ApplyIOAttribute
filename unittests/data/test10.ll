...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test10.cpp, i8* null }]
...
define internal void @_GLOBAL__sub_I_test10.cpp() section ".text.startup" {
entry:
